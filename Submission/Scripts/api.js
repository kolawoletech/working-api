        ...
        $.when(
            ...
            $.ajax({
                ...
                success: function (response2) {
                    ...
                    Output2 += '<button id="addToMovieCollectionRecord" class="btn btn-template-outlined btn-lg btn-danger"><i class="fa fa-shopping-cart"></i> Add to Collection</button>'
                    Output2 += '<button  data-toggle="tooltip" data-placement="top" title="Add to wishlist" class="btn btn-warning btn-lg"><i class="fa fa-heart-o"></i></button>'
                    Output2 += '</p>'
                    Output2 += '</form>'
                    Output2 += '</div></div></div>'
