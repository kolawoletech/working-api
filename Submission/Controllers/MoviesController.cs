...
namespace Submission.Controllers
{
    ...
    public class MoviesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MovieId,Title,Plot,Genre,Rating,Actors,Favorited")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MovieId,Title,Plot,Genre,Rating,Actors,Favorited")] Movie movie)
        {
            if (ModelState.IsValid)
            {
